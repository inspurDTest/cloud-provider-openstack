...
require (
	...
	github.com/inspurDTest/cloud-provider v0.29.0-33
	github.com/inspurDTest/gophercloud v1.6.0-39
...
replace (
	github.com/inspurDTest/cloud-provider => github.com/inspurDTest/cloud-provider v0.29.0-33
