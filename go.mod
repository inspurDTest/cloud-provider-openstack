...
require (
	...
	github.com/inspurDTest/gophercloud v1.6.0-32
	github.com/inspurDTest/utils v1.0.0-1
...
replace (
	github.com/inspurDTest/cloud-provider => github.com/inspurDTest/cloud-provider v0.29.0-32
